          ...
          <ul class="menu">
            ...
            <li class="dropdown dropdown-6">
              ...
              <ul class="dropdown_menu dropdown_menu--animated dropdown_menu-6">
                <li class="dropdown_item-1">Tokenomics</li>
                <li class="dropdown_item-2">Token supply</li>
                <li class="dropdown_item-3">Governance</li>
                <li class="dropdown_item-4">Team</li>
              </ul>
            </li>
            <li class="dropdown dropdown-6">
              Social<span className='ms-2'><BsCaretDownFill/></span>
              <ul class="dropdown_menu dropdown_menu--animated dropdown_menu-6">
                <li class="dropdown_item-1">Discord</li>
                <li class="dropdown_item-2">Telegram</li>
                <li class="dropdown_item-3">Twitter</li>
                <li class="dropdown_item-4">Reddit</li>
              </ul>
            </li>
            <li class="dropdown dropdown-6">
              More<span className='ms-2'><BsCaretDownFill/></span>
              <ul class="dropdown_menu dropdown_menu--animated dropdown_menu-6">
                <li class="dropdown_item-1">LITEPAPER</li>
                <li class="dropdown_item-2">FAQ</li>
              </ul>
            </li>
          </ul>
        </nav>
